...
export const EmptyState: React.FC<EmptyStateProps> = ({ variant = 'no-data', title, message }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.message, { color: colors.icon }]}>{message ?? 'Try again later.'}</Text>
    </View>
  );
};
